...
// rectangle.  The layout is exported to a text file within
// activations_subdir which can be ingested by program
// mains/photosynth/fill_photo_hierarchy within the IMAGESEARCH
// pipeline.  NETGRAPH next generates an edgelist file in
// activations_subdir which can be ingested by program
...
// ORDER_ACTIVATIONS:
   ...
   string weight_sums_subdir = activations_subdir + "weight_sums/";
   filefunc::dircreate(weight_sums_subdir);
...
// pipeline:
   ...
   string graph_layout_filename=activations_subdir+
      "graph_XY_coords.fm3_layout";
...
// pipeline.
       ...
       major_layer_ID++)
   {
      ...
      weights_prob.set_densityfilenamestr(weight_sums_subdir+
