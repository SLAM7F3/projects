...
// Important node added on Sunday, Sep 18, 2016: We must make sure
// that the ordering of node IDs is consistent with the ordering of
// input test/validation image names !!!
