// ====================================================================
// Program DOWNSIZE_IMAGES imports all images within a specified input 
// subdirectory.  It then downsizes any image within the input folder
// whose horizontal or vertical pixel dimensions exceeds max_xdim /
// max_ydim.  
// ====================================================================
// Last updated on 1/8/16; 1/9/16
// ====================================================================
