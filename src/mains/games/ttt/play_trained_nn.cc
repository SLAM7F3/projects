// ==========================================================================
// Program PLAY_TRAINED_NN allows a minimax AI to play against a
// trained agent.  It expects to find a "snapshot.txt" soft link
// sitting within ./experiments/pi_sigma/exptXXX/snapshots/ . 
// ==========================================================================
