// ==========================================================================
// Program GIST_COLOR_GRAPH imports a set of thumbnails from a
...
// GIST_COLOR_GRAPH subsequently computes edge weights between all
// image nodes.  We require that two images' color and GIST contents
// be reasonably similar before a graph edge between them is formed.
// This program exports an edge list which represents a combined
// GIST-color graph for the imagery corpus.

// 				./gist_color_graph

// ==========================================================================
// Last updated on 8/1/13; 8/11/13; 8/15/13
// ==========================================================================
...
// Export quantized image colorings edge list:
   ...
   string output_filename=colorhist_subdir+"image_gist_colors_edgelist.dat";
   ofstream outstream;
   ...
   banner="Exported image gist-color graph edge list to "+output_filename;
   ...
   cout << "At end of program IMAGE_GIST_COLOR_GRAPH" << endl;
   outputfunc::print_elapsed_time();
}
