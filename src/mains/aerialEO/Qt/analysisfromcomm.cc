// ========================================================================
// Simulation program for Peter's analyst workstation receiving byte
// messages from Alex' ground-air communications workstation.

// 			      analysisfromcomm

// ========================================================================
// Last updated on 10/15/09; 11/25/09; 11/30/09
// ========================================================================
...
{
   cout << "=====================================================" << endl;
   cout << "Starting PETER'S ANALYSIS machine message receiver:" << endl;
   cout << "=====================================================" << endl;
...
//   string message_queue_channel_name = "ROI_TRACK_UPDATE";  
//   string message_queue_channel_name = "ROI_IMAGE_UPDATE";
//   string message_queue_channel_name = "NFOV_IMAGE_UPDATE";
//   string message_queue_channel_name = "WFOV_IMAGE_UPDATE";
   string message_queue_channel_name = "SYSTEM_STATUS";  
//   string message_queue_channel_name = "CONSOLE";
   string message_sender_ID="AIR_CLIENT_00";
      ...
      if (m.copy_messages_and_purge_mailbox())
      {
         ...
         for (int i=0; i<m.get_n_curr_messages(); i++)
         {
            ...
            if (curr_message_ptr != NULL)
            {
               ...
               string Message;
               m.reconstruct_SystemStatus_message(Message);
//               m.reconstruct_ROI_message(Message);
            }
