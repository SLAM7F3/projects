// ========================================================================
// Program WISPMASK is a variant of WISPROP.  It iterates over the
// HAFB minimap geotif and projects each voxel into the 2D image plane
// for the first WISP panel.  WISPMASK outputs jpeg images
// displaying masks for world X, Y and Z values within the WISP image
// plane.
...
--region_filename ./packages/wisp_p0_000100.pkg \
--region_filename ./packages/wisp_p1_000100.pkg \
--region_filename ./packages/wisp_p2_000100.pkg \
--region_filename ./packages/wisp_p3_000100.pkg \
--region_filename ./packages/wisp_p4_000100.pkg \
--region_filename ./packages/wisp_p5_000100.pkg \
--region_filename ./packages/wisp_p6_000100.pkg \
--region_filename ./packages/wisp_p7_000100.pkg \
--region_filename ./packages/wisp_p8_000100.pkg \
--region_filename ./packages/wisp_p9_000100.pkg \
--ActiveMQ_hostname tcp://127.0.0.1:61616 \
--initial_mode Manipulate_Fused_Data_Mode

*/

// Make sure 2D window displays "Fuse Data Mode".  Then within this
// window, press 't' in order to generate terrain masks.

// ========================================================================
// Last updated on 11/14/11; 11/19/11; 12/25/11
// ========================================================================
...
// Read photographs from input video passes:
   ...
   photogroup_ptr->set_selected_photo_ID(0);
...
//   bool hide_Mode_HUD_flag=true;
   ...
   ModeController_2D_ptr->setState(ModeController::FUSE_DATA);
...
//   movies_group.set_DTED_ztwoDarray_ptr(DTED_ztwoDarray_ptr);
   ...
   movies_group.set_raytracer_ptr(ray_tracer_ptr);
...
//   bool thumbnails_flag=true;
   ...
   double frustum_sidelength=2000;
...
// 2D imagery for draping purposes:
   ...
   FusionGroup_ptr->set_ground_photogroup_ptr(photogroup_ptr);
