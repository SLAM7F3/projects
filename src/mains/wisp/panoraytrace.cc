// ========================================================================
// Program PANORAYTRACE is a variant of PANOVSLADAR which performs
// line-of-sight raytracing for the WISP panoramic video camera.
// An empty MODEL holding the OBSFRUSTAGROUP for WISP's 10 cameras is
// instantiated.  A single geotif holding ALIRT HAFB minimap heights
// in the vicinity of FOB Blessing is also imported.  After performing
// LOST-like raytracing, terrain regions around FOB Blessing which are
// visible [occluded] to WISP are shaded in green [red].  Terrain
// locations lying outside WISP's field-of-view are shaded grey.

/*
./panoraytrace \
--region_filename ./packages/raytracing/FOB.pkg \
--region_filename ./packages/raytracing/panel0.pkg \
--region_filename ./packages/raytracing/panel1.pkg \
--region_filename ./packages/raytracing/panel2.pkg \
--region_filename ./packages/raytracing/panel3.pkg \
--region_filename ./packages/raytracing/panel4.pkg \
--region_filename ./packages/raytracing/panel5.pkg \
--region_filename ./packages/raytracing/panel6.pkg \
--region_filename ./packages/raytracing/panel7.pkg \
--region_filename ./packages/raytracing/panel8.pkg \
--region_filename ./packages/raytracing/panel9.pkg \
...
// ========================================================================
// Last updated on 2/21/11; 6/3/11; 6/5/11
// ========================================================================
...
//   double max_ground_sensor_range=0.5*1000;	// meters
//   double max_ground_sensor_range=1*1000;	// meters
   double max_ground_sensor_range=2*1000;	// meters
//   double max_ground_sensor_range=5*1000;	// meters
...
// Instantiate TilesGroup to perform raytracing computations:
   ...
   FOV_triangle_min_az=0;
   FOV_triangle_max_az=359.99*PI/180.0;
