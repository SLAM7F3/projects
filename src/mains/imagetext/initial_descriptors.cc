...
// from each image.  It converts the 8x8 patches into a 64x1 column
// vector of grey-scale intensities.  Raw descriptors for all
...
// ==========================================================================
// Last updated on 5/31/13; 4/6/14; 5/24/14; 6/7/14
// ==========================================================================
...
//   string raw_char_subdir="./training_data/synthetic_chars/";
   string raw_char_subdir="./training_data/tree_chips/";
   ...
   vector<string> image_filenames=
      filefunc::files_in_subdir_matching_specified_suffixes(
         allowed_suffixes,raw_char_subdir,search_all_children_dirs_flag);

   const unsigned int D=64;	// 8 x 8 patches
   const unsigned int n_patches_per_image=12;

   vector<descriptor*>* D_ptrs_ptr=new vector<descriptor*>;
   texture_rectangle* texture_rectangle_ptr=new texture_rectangle();

//   unsigned int max_n_descriptors = 100;
   unsigned int max_n_descriptors = 1000000;		// text chars
   int R,G,B;
   double h,s,v;
