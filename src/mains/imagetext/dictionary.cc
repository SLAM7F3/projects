...
// WHITEN_DESCRIPTORS for 8x8 pixel patches randomly selected from
// text character images.  It initially fills dictionary matrix D with
// column vectors populated via a Normal distribution and normalized
// to unit magnitude.  It then iteratively updates score matrix S and
// dictionary D following the prescription laid out in "Learning
// feature representations with K-means" by Coates and Ng, 2013.
// After each iteration, a PNG file is generated which illustrates all
// K 8x8 dictionary elements.  The final values in D are exported to a
// binary HDF5 file.

// 				dictionary

// ==========================================================================
// Last updated on 8/23/12; 11/24/12; 5/26/14; 6/13/14
// ==========================================================================
