// ==========================================================================
// WHITEN_DESCRIPTORS imports contrast normalized 64x1 descriptors for
// 8x8 pixel patches selected from character jpeg images generated by
// program INITIAL_DESCRIPTORS.  It computes the descriptors'
// covariance matrix along with a regularized version of its inverse
// square root covariance matrix.  Each input descriptor is whitened
// by multiplying it by the inverse square root covariance matrix.
// Whitened patch descriptors are exported to a single
// HDF5 binary file.  The inverse square root of the covariance matrix
// is also exported to a text file within the dictionary subdirectory.

//			    whiten_descriptors

// ==========================================================================
// Last updated on 11/24/12; 5/25/14; 5/26/14; 5/31/14
// ==========================================================================
...
// Note: Adoptic eps_ZCA = 0.1 leads to a covariance matrix for
