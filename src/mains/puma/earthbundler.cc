...
// ========================================================================
// Last updated on 5/19/13; 5/20/13; 12/10/13
// ========================================================================
...
// Use an ArgumentParser object to manage the program arguments:
   ...
   string puma_metadata_filename=bundler_IO_subdir+"puma.metadata";
...
//   earth_regions_group.set_OSGgroup_nodemask(0); // hide surface texture
