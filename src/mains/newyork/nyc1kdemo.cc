// ========================================================================
// Program NYC1KDEMO is a variant of BUNDLECITIES which we have
// specialized for Family Day 2011 infinite loop demo purposes.
// ========================================================================
...
// FAKE FAKE:  Weds Sep 14 , 2011 at 7:30 am

// For anim path purposes, reset min camera height above grid

   CM_3D_ptr->set_min_camera_height_above_grid(20);	// meters
...
//   clouds_group.set_auto_resize_points_flag(true);
   clouds_group.set_update_display_flag(false);
   ...
   earth_regions_group.set_update_display_flag(false);
...
//    SignPostsGroup_ptr->set_update_display_flag(false);
