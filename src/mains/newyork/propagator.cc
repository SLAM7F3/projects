// ========================================================================
// Program PROPAGATOR is a variant of program BUNDLECITIES.  It pops
// open a 3D window displaying the NYC ladar cloud and georegistered
// OBSFRUSTA.  It also opens a 2D window in which the photo for the
// most recently selected OBSFRUSTUM is displayed.  
...
// into different image planes.  Sky and ocean pixels may also be
// identified via ray tracing.

// ========================================================================
// Last updated on 10/3/09; 5/11/10; 5/12/10; 2/2/11
// ========================================================================
...
// Instantiate TilesGroup to perform raytracing computations:
   ...
   int UTM_zone=18;	// NYC
   TilesGroup_ptr->set_specified_UTM_zonenumber(UTM_zone);	// NYC
   TilesGroup_ptr->set_northern_hemisphere_flag(northern_hemisphere_flag);   
   geopoint lower_left_corner(
      northern_hemisphere_flag,UTM_zone, 582789.125, 4505938 , 0);
   geopoint upper_right_corner(
      northern_hemisphere_flag,UTM_zone, 590686.25 , 4522753.5 , 0);
   ...
   string geotif_subdir="/data/ladar/RTV/new_york/";
   string geotif_filename=geotif_subdir+"nyc_heights_1m.tif";
...
//   PROPAGATOR_TYPE propagator_type=polyhedra;
   ...
   imageplane_SignPostsGroup_ptr->set_extra_textmessage_info(
      " New York City wiki ");
