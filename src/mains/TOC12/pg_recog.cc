// ==========================================================================
// Program PG_RECOG is a main program which takes in sets of input
// video frames from PointGrey cameras and searches for all 9 final
// TOC12 signs within them.

//				pg_recog

// ==========================================================================
// Last updated on 11/2/12; 11/3/12; 11/4/12
// ==========================================================================
...
//      string blimp_signs_subdir=
//         "./images/blimp_imagery/jpg_images/blimp_images/";
//      vector<string> image_filenames=filefunc::image_files_in_subdir(
//         blimp_signs_subdir);
...
//            texture_rectangle_ptr->write_curr_frame(bboxes_filename);
            ...
            string annotated_bboxes_filename=video_subdir+
