...
// ignored.  Among the known-gender 20K male + 20K female face chips,
// a small percentage are marked for testing while a smaller
// percentage are designated as validation.  Data augmentation
// (translation, hsv color modification, noise injection) is performed
// on the remaining training images.  Female and male subdirectories
// are formed within an output tree of training, validation and
// testing folders.  All face chips are exported to one of these
// subdirectories after their pixel sizes are constrained to not
// exceed 96 x 96.

//			      ./augment_chips

// ========================================================================
// Last updated on 8/1/16; 8/2/16; 8/14/16; 9/10/16
// ========================================================================
...
//            n_augmentations_per_chip = 6;
            n_augmentations_per_chip = 7;   // 20K male + 20K female
         }
