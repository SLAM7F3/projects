// ========================================================================
// Program AUGMENT_IRAN_CHIPS imports a set of 106x106 image chips
// extracted from the Iran facial data set via program
// IRAN_IMAGES.  Since Iran faces originate from flickr imagery
...
// Iran chips for validation and testing.  And we only take only 2
// augmented copies of each remaining Iran image for training
...
// ========================================================================
// Last updated on 8/3/16; 9/10/16
// ========================================================================
...
int main( int argc, char** argv )
{
   ...
   string iran_chips_subdir = "./resized_iran_female_faces/";
   ...
   string output_chips_subdir = "./augmented_iran_face_chips/";
...
// some relatively small percentage of output tiles:
         ...
         string output_filename= output_subdir + 
            gender_value+"_iran_face_"+image_ID_str+"_"
...
// Iran images appear to have all been rotated so that the face
...
// chips in order to remove this artificial regularity:
      ...
      delete tr_ptr;
      image_counter++;
   } // loop over index n labeling input iran 106x106 image chips
