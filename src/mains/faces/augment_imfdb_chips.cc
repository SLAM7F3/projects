// ========================================================================
// Program AUGMENT_IMFDB_CHIPS imports a set of 106x106 image chips
// extracted from the Imfdb facial data set via program
// IMFDB_IMAGES.  Since Imfdb faces originate from flickr imagery
...
// Imfdb chips for validation and testing.  And we only take only 2
// augmented copies of each remaining Imfdb image for training
...
int main( int argc, char** argv )
{
   ...
   string imfdb_chips_subdir = faces_subdir+"imfdb_faces/";
   ...
   string output_chips_subdir = "./augmented_imfdb_face_chips/";
   ...
   for(int n = 0; n < n_images; n++)
   {
      ...
      else if (tvt >= 0.25 * 0.0125 && tvt < 0.25 * 0.05)
      {
...
// Imfdb images appear to have all been rotated so that the face
...
// chips in order to remove this artificial regularity:
      ...
      delete tr_ptr;
      image_counter++;
   } // loop over index n labeling input imfdb 106x106 image chips
