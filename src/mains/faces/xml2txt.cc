...
// unset attribute values to gender and age_group attribute keys for
...
// ====================================================================
// Last updated on 7/5/16; 7/6/16; 7/19/16
// ====================================================================
...
// Export face and hand bounding boxes to output text file:
   ...
   string output_filename=labeled_faces_subdir+"initial_labeled_bboxes.txt";
   ofstream outstream;
...
// default:
         ...
         if(curr_box.label == "face")
         {
            ...
            curr_bbox.get_attributes_map()["gender"] = "unset";
            curr_bbox.get_attributes_map()["age_grp"] = "unset";
