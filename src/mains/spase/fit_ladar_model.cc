// ==========================================================================
// Program FIT_LADAR_MODEL
// ==========================================================================
// Last updated on 7/8/05; 1/29/12
// ==========================================================================
...
// into alignment with 12/29/04 JIGSAW pass #3 data:
   ...
   xyzpfunc::rotate(R.transpose(),xyzp_pnt_ptr);
   xyzpfunc::translate(threevector(-0.146,0.34,0.842),xyzp_pnt_ptr);
...
// Write all XYZP points to output_dir subdirectory:
   ...
   string xyzp_filename=output_subdir+"pass3_model.xyzp";
