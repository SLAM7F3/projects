...
bool CFrustum::BoxInFrustum(float xmin,float ymin, float zmin, float xmax, float ymax, float zmax)  // MIT Lincoln Laboratory, Luke Skelly
{
	for(int i = 0; i < 6; i++ )
	{
		if(m_Frustum[i][A] * (xmin) + m_Frustum[i][B] * (ymin) + m_Frustum[i][C] * (zmin) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (xmax) + m_Frustum[i][B] * (ymin) + m_Frustum[i][C] * (zmin) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (xmin) + m_Frustum[i][B] * (ymax) + m_Frustum[i][C] * (zmin) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (xmax) + m_Frustum[i][B] * (ymax) + m_Frustum[i][C] * (zmin) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (xmin) + m_Frustum[i][B] * (ymin) + m_Frustum[i][C] * (zmax) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (xmax) + m_Frustum[i][B] * (ymin) + m_Frustum[i][C] * (zmax) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (xmin) + m_Frustum[i][B] * (ymax) + m_Frustum[i][C] * (zmax) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (xmax) + m_Frustum[i][B] * (ymax) + m_Frustum[i][C] * (zmax) + m_Frustum[i][D] > 0)
		   continue;
