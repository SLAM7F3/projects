...
// line-of-sight raytracing for the D7 panoramic video camera hoisted
// aloft a mast outside the flight facility in July 2010.  The D7's
// camera parameters were determined via program GEOREGPANO.  An empty
// MODEL holding the OBSFRUSTAGROUP for the D7's 5 cameras is
// instantiated.  A single geotif holding ALIRT HAFB minimap heights
// in the vicinity of the flight facility is also imported.  After
// performing LOST-like raytracing, terrain regions in the
// HAFB minimap which are visible [occluded] to the D7 are shaded in
// green [red].  Terrain locations lying outside the D7's
// field-of-view are shaded grey.
...
--region_filename ./packages/cropped_image_p0-00003.pkg \
--region_filename ./packages/cropped_image_p1-00003.pkg \
--region_filename ./packages/cropped_image_p2-00003.pkg \
--region_filename ./packages/cropped_image_p3-00003.pkg \
--region_filename ./packages/cropped_image_p4-00003.pkg \
...
// ========================================================================
// Last updated on 1/23/11; 2/5/11; 2/6/11; 2/21/11
// ========================================================================
...
//   double max_ground_sensor_range=2*1000;	// meters
   double max_ground_sensor_range=4*1000;	// meters
...
// Set fixed_to_mutable_colors_flag=true for ladar coloring purposes:
   ...
   OBSFRUSTAGROUP_ptr->compute_D7_FOV(FOV_triangle_min_az,FOV_triangle_max_az);
