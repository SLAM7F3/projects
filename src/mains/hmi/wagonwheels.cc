// ========================================================================
// Program WAGONWHEELS is a variant of "Google Streets" meant for
// indoor panorama viewing via HMI devices.
// ========================================================================
// Last updated on 3/31/11; 4/1/11; 4/4/11
// ========================================================================
...
// Instantiate a WiiMote object to detect button clicks:
...
// As of 3/31/11, we automatically read in cyber signposts and project
// them into the closest panorama:
...
//      INS.update_avg_physical_acceleration();

      WM.update_state();
//      WM.get_button_clicked_flag();
      WM.get_curr_button_value();
   }
