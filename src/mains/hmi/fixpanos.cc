// ========================================================================
// FIXPANOS is a variant of VIEWPANOS which is intended to be used to
// correct faulty D7/XSENS orientation and position information.
// ========================================================================
// Last updated on 8/4/11; 8/16/11; 8/17/11
// ========================================================================
...
//   double local_spin_daz=6.6*36*PI/180;	// Aud data #2 fudge factor
   ...
   string banner="Enter initial pano ID:";
   outputfunc::write_big_banner(banner);
   cin >> initial_pano_ID;

   banner="Enter azimuthal spin angle in degrees:";
   outputfunc::write_big_banner(banner);
   cin >> local_spin_daz;
...
//   window_mgr_ptr->set_viewer_horiz_vert_fovs(hfov,vfov);
   ...
   PanoramasGroup_ptr->set_selected_Panorama_ID(initial_pano_ID);
   PanoramasGroup_ptr->recenter_virtual_camera_over_wagonwheel(
      initial_pano_ID);
