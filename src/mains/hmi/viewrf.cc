...
// Program VIEWRF
// ========================================================================
// Last updated on 8/20/11; 8/23/11; 9/7/11
// ========================================================================
...
// Instantiate SphereSegmentsGroup to display RF direction finding
// results:

   SphereSegmentsGroup* SphereSegmentsGroup_ptr=decorations.add_SphereSegments(
      pass_ptr);

//   string banner="Enter full path for 'rf_results.txt' generated by program RF_DIRFINDER:";
//   outputfunc::write_big_banner(banner);

   string rf_dir_filename;
//   cin >> rf_dir_filename;
//   string subdir="./dir_finder/LL-Pavilion-2011-08-03/";
//   string subdir="./dir_finder/LL-Pavilion-2011-08-23/";
   string subdir="./dir_finder/LL-Pavilion-2011-09-06/";
   rf_dir_filename=subdir+"rf_results.txt";

   SphereSegmentsGroup_ptr->generate_RF_direction_segments(
      rf_dir_filename);
