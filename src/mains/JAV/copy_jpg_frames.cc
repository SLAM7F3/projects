// =======================================================================
// Program COPY_JPG_FRAMES is a specialized utility we wrote in order
// to rename video frames extracted from Boston Bombing video clips so
// that they conform to our JAV naming conventions.  It generates an
// executable script filled with cp commands that can be used to fill
// an appropirate subdirectory of /data/ImageEngine/.
// =======================================================================
...
// sort the strings within STL vector video_filenames:
   ...
   string output_filename=images_subdir+"copy_video_frames";
   ofstream outstream;
...
*/
      ...
      string destination_frame_filename="clip_"+stringfunc::integer_to_string(
         ...
         "."+suffix;
      string unix_cmd="cp \""+curr_frame_filename
