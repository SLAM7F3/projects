// ========================================================================
// Program TOURCITIES is a variant of program TESTCITIES wherein
// virtual 3D tours passing through virtual and real OBSFRUSTA can be
// conducted. 
// ========================================================================
// Last updated on 3/4/11; 3/6/11
// ========================================================================
...
// Instantiate PhotoToursGroup & generate new PhotoTour:
...
// Specify IDs for OBSFRUSTA to be included in PhotoTour:   

   vector<int> tour_OBSFRUSTUM_IDs;
   for (int i=0; i<n_photos; i++)
   {
      tour_OBSFRUSTUM_IDs.push_back(i);
   }
   PhotoTour_ptr->specify_tour_OBSFRUSTUM_IDs(tour_OBSFRUSTUM_IDs);
   PhotoToursGroup_ptr->set_conduct_tours_flag(true);
