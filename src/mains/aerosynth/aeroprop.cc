// ========================================================================
// Program AEROPROP is a variant of mains/photosynth/PROPAGATOR.  It pops
// open a 3D window displaying a point cloud (ladar and/or bundler
// reconstructed) and georegistered aerial video frames' OBSFRUSTA.
// It also opens a 2D window in which the video frame for the most
// recently selected OBSFRUSTUM is displayed.
...
// ========================================================================
// Last updated on 1/29/11; 2/7/11; 2/27/11
// ========================================================================
...
//    movies_group.set_DTED_ztwoDarray_ptr(DTED_ztwoDarray_ptr);
   movies_group.set_play_photos_as_video_flag(true);
   movies_group.set_aerial_video_frame_flag(true);
