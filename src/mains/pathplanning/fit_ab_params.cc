// ========================================================================
// Program FIT_AB_PARAMS is a specialized utility which we wrote for
// TOC11.  It loads in some set of simulated dynamic hits along a
// "mystery" path whose alpha and beta cost function coefficients are
// regarded as unknown.  Looping over alpha-beta parameter space,
// FIT_AB_PARAMS generates A* paths through ALIRT data between specified
// starting and stopping points.  It computes the average minimal distance
// between all simulated dynamic points and each candidate alpha-beta
// path.  FIT_AB_PARAMS iteratively refines its alpha-beta parameter
// search based upon the top few scored paths in the previous iteration.

// When running on laptop, data_subdir=/media/66368D22368CF3F9/
// When running on BEAST, data_subdir=/data_second_dis/

// From within data_subdir/TOC11/FOB_Blessing/FOB_Blessing_tiles/z_tif_tiles/tiles/filtered_Z_tiles/osga

//  ~cho/programs/c++/svn/projects/src/mains/pathplanning/fit_ab_params *.osga

// Within MANIPULATE_ANNOTATION_MODE, press 'r' to read in starting
// and stopping path locations on 3D map.  Then press 'b' to search
// for best alpha-beta values which match input dynamic path points.

// ========================================================================
// Last updated on 8/2/11; 8/3/11
// ========================================================================
...
//   string subdir="/media/66368D22368CF3F9/TOC11/FOB_Blessing/FOB_Blessing_tiles/z_tif_tiles/tiles/filtered_Z_tiles/tif/";
...
// Instantiate TilesGroup to perform raytracing computations:
   ...
   string data_subdir=
//      "/media/66368D22368CF3F9";
      "/data_second_disk";
   string geotif_subdir=data_subdir+
      "/TOC11/FOB_Blessing/FOB_Blessing_tiles/z_tif_tiles/tiles/filtered_Z_tiles/tif/";
...
//   double northing_hi=3882684.000;
   ...
   for (int j=0; j<geotif_filenames.size(); j++)
   {
