...
// bundler_IO_subdir.
// ==========================================================================
// Last updated 9/11/13; 12/3/13; 11/10/15; 11/11/15
// ==========================================================================
...
// Call RadialUndistort on list_tmp.txt:
...
// Convert ply file exported by PMVS to tdp format:
   ...
   unix_cmd=projects_rootdir+"/src/mains/aerosynth/ply2tdp --region_filename "
