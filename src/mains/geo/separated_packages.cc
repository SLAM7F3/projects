...
//         cout << "image j = " << image_j_filename << endl;
   ...
   string unix_cmd="cp "+restricted_asift_scriptfilename+" "+geo_mains_subdir;
   sysfunc::unix_command(unix_cmd);
   unix_cmd="cp "+triangulate_scriptfilename+" "+geo_mains_subdir;
   sysfunc::unix_command(unix_cmd);
   unix_cmd="cp "+gpsfit_scriptfilename+" "+geo_mains_subdir;
   sysfunc::unix_command(unix_cmd);
   unix_cmd="cp "+videoprop_scriptfilename+" "+geo_mains_subdir;
   sysfunc::unix_command(unix_cmd);
   unix_cmd="cp "+orthorectify_scriptfilename+" "+geo_mains_subdir;
   sysfunc::unix_command(unix_cmd);
