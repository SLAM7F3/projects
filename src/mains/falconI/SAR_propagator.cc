...
// ========================================================================
// Last updated on 10/1/12; 10/2/12; 10/3/12; 3/12/13
// ========================================================================
...
//   bool display_SAR_rays_flag=false;
   ...
   if (display_SAR_rays_flag)
   {
      ...
      string SAR_subdir=
         "/home/cho/programs/c++/svn/projects/src/mains/falconI/SAR_images/";
      ...
      for (unsigned int p=0; p<SAR_LOS_PolyLinesGroup_ptr->get_n_Graphicals();
           p++)
      {
