...
// image files, it randomly chooses a 32x32 window within some image.
...
// ==========================================================================
// Last updated on 6/25/12; 8/23/12; 6/1/14; 6/17/14
// ==========================================================================
...
int main(int argc, char* argv[])
{
   ...
   string nontext_subdir="./training_data/not_text/";
   ...
   string extracted_nontext_images_subdir="./training_data/nontext_images/";
