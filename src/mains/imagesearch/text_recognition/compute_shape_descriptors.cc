...
// corresponding to previously thresholded text and non-text character
// regions generated by programs GENERATE_EXTREMAL_REGIONS.  Following
...
// ==========================================================================
// Last updated on 7/11/12; 7/27/12; 8/7/12
// ==========================================================================
...
// As of 6/23/2012, we have 736 [821] examples of 32-pixel high
// images containing dark [bright] character extremal regions against
// bright [dark] backgrounds

   vector<string> allowed_suffixes;
   allowed_suffixes.push_back("png");
   string extremal_region_subdir=
      "./training_data/char_intensity/extremal_regions/";

//   int text_type_flag=0;	// non-text
//   int text_type_flag=1;	// True text
   int text_type_flag=2;	// Symbol

   string features_filename;
   if (text_type_flag==0)
   {
      extremal_region_subdir += "all_nontext_extremal_regions/";
      features_filename="nontext_features.dat";
   }
   else if (text_type_flag==1)
   {
      extremal_region_subdir += "all_chars_extremal_regions/";
      features_filename="text_features.dat";
   }
   else if (text_type_flag==2)
   {
      extremal_region_subdir += "all_symbols_extremal_regions/";
      features_filename="symbol_features.dat";
   }
...
//   int i_stop=10;
   ...
   cout << "char_image_filenames.size() = " << i_stop << endl;
...
// connected component:
      ...
      if (treenode_ptrs.size() != 1) continue;

      unsigned int left_bottom_pu,left_bottom_pv,right_top_pu,right_top_pv;
      for (unsigned int n=0; n<treenode_ptrs.size(); n++)
      {
