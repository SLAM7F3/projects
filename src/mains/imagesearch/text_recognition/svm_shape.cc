...
// ==========================================================================
// Last updated on 8/6/12; 8/7/12; 8/8/12
// ==========================================================================
...
// Import text and non-text extremal region shape descriptors:
   ...
   string nontext_features_filename=extremal_regions_subdir+
      "nontext_features.dat";
...
// margins which are desirable:
   ...
   double min_C=0.25; // smaller C means bigger margin
   double max_C=8;
   double delta_C=2;
...
// TEXT
//   double gamma=0.4;	// 11 features
//   double C=2;	// 11 features
...
// learned_pfunct object to disk and recall it later like so:
   ...
   string bfunction_filename="learned_bifunc_"+
   ...
   string banner="Exported learned binary function to "+
      bfunction_filename;
...
// learned_pfunct object to disk and recall it later like so:
   ...
   string pfunction_filename="learned_pfunct_"+
      stringfunc::number_to_string(Ntext)+"_"+
      stringfunc::number_to_string(Nnontext)+".dat";
...
// objects they contain:
   ...
   cout << "Reloading binary learned function:" << endl;
