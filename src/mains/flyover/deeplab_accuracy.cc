// ==========================================================================
// Program DEEPLAB_ACCURACY imports a caffe.bin.INFO file generated by
...
// epoch number of the validation set.

//			       deeplab_accuracy

// ==========================================================================
// Last updated on 10/14/15; 10/15/15; 10/20/15; 10/21/15
// ==========================================================================
...
//   int n_images_per_epoch = 20000;	// "full" training
   ...
   int n_images_per_iteration = 30;	// "batch" size
   double n_iters_per_epoch = n_images_per_epoch / n_images_per_iteration;	// 66 iters = 1 epoch for 2K images

   int n_training_images = n_images_per_epoch;
   int n_validation_images = 0.25 * n_training_images;
   ...
   cout << "20 epochs = " << 20 * n_iters_per_epoch << " iterations" << endl;	// 1333 iters for 2K images
   ...
   vector<double> training_accuracy_0, training_accuracy_1, training_accuracy_2;
   vector<double> validation_accuracy_0, validation_accuracy_1, validation_accuracy_2;
   vector<double> loss;
   for(unsigned int i = 0; i < filefunc::text_line.size(); i++)
   {
	...
	int curr_iteration_number = stringfunc::string_to_number(substrings[5]);
