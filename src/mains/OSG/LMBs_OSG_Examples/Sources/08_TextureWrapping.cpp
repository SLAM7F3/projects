/******************************************************************************\
* TextureWrapping                                                              *
* Texture a polygon directly in C++, setting the wrapping parameters.          *
...
osg::ref_ptr<osg::Geode> CreateGeometry()
{
   ...
   // Setting wrapping parameters is easy as this
   ...
   texCoords->push_back (osg::Vec2 (10.0, 0.0));
   texCoords->push_back (osg::Vec2 (5.0, 10.0));
