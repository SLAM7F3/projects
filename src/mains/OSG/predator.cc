// ========================================================================
// Program PREDATOR is a stripped version of TESTTEXTURE which we
// created for experimenting with adding OBSFRUSTA volume alpha blending.

//  	   predator --surface_texture ./packages/sanclemente_EO.pkg

// ========================================================================
// Last updated on 12/17/07; 7/9/08; 5/27/09
// ========================================================================
