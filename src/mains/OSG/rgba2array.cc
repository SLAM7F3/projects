// ==========================================================================
// Program RGBA2ARRAY reads in a sequence of XYZRGBA files and writes
// out a single color array file for subsequent 4D movie playback via
// programs VIEWDRAPE or SATDRAPE.  The starting, stopping and
...
// ==========================================================================
// Last updated on 12/20/06; 1/2/07; 4/23/07
// ==========================================================================
...
// Instantiate group to hold pointcloud information:
        ...
        imagenumber += imagenumber_skip)
   {
      ...
      string banner="Extracting colors from image "+imagenumber_str;
