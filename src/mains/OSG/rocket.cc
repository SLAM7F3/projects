// ========================================================================
// Program ROCKET is a testing lab for instantiating and
// manipulating surfaces of revolution.  It also
// stands alone from any point cloud input.

//				rocket

// ========================================================================
// Last updated on 8/4/13
// ========================================================================
...
// Experiment with surfaces of revolution:
   ...
   cout << "rocket_height = " << rocket_height << endl;

   threevector true_tip(20,11,9);
   threevector true_base(0,9,5);

   double true_rocket_height=(true_tip-true_base).magnitude();	// meters
   threevector scale(1,1,true_rocket_height/rocket_height);
   threevector r_hat=(true_tip-true_base).unitvector();
...
// Instantiate Polyhedra, Polygons & PolyLines decoration groups:
   ...
   threevector trans=*grid_origin_ptr;
   trans += true_base;
