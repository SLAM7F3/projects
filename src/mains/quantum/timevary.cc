// ==========================================================================
// Program TIMEVARY computes final state energies for quantum systems
// which evolve in the presence of a time-varying classical
...
// original values for t2 < t.  TIMEVARY computes quantum system's
