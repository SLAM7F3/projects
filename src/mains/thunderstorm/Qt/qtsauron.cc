// ========================================================================
// Program QTSAURON is a variant of SAURON
// ========================================================================
// Last updated on 10/12/11; 10/13/11
// ========================================================================
...
// Instantiate ActiveMQ messengers:
   ...
   string message_sender_ID="QTSAURON";
...
//   cout << "first_frame_filename = " << first_frame_filename << endl;
   starting_image_subdir=filefunc::getdirname(first_frame_filename);
//   cout << "starting_image_subdir = " << starting_image_subdir << endl;
...
// Instantiate group to hold movie:
   ...
   Movie_server.set_MoviesGroup_ptr(MoviesGroup_ptr);
...
// Instantiate SignPostsGroup to hold ground target locations:
   ...
   SignPostsGroup* GroundTarget_SignPostsGroup_ptr=decorations_3D.add_SignPosts(
      ndims,passes_group.get_pass_ptr(cloudpass_ID));
...
/*
   string center_char;
   cout << "Enter 'c' to center Aircraft in 3D viewer display:" << endl;
   cin >> center_char;
   if (center_char=="c")
   {
      Aircraft_MODELSGROUP_ptr->set_selected_Graphical_ID(
         Aircraft_MODEL_ptr->get_ID());
   }
*/
