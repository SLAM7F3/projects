...
// ========================================================================
// Last updated on 4/23/12; 4/24/12; 1/2/13
// ========================================================================
...
// Use an ArgumentParser object to manage the program arguments:
   ...
   cout << endl;
   cout << "Enter Nov 2012 experiment day number (e.g. 1,2):" << endl;
   cin >> expt_daynumber;
   cout << "Enter experiment label (e.g. A,B,C,D,E,H)" << endl;
   cin >> expt_label;
   ...
   vector<int> video_camera_ID;
   video_camera_ID.push_back(1);
   video_camera_ID.push_back(2);
   video_camera_ID.push_back(3);
   video_camera_ID.push_back(4);
   video_camera_ID.push_back(5);
   video_camera_ID.push_back(6);
   video_camera_ID.push_back(7);
   video_camera_ID.push_back(8);
   video_camera_ID.push_back(9);
   video_camera_ID.push_back(10);

// FAKE FAKE: Thurs Jan 3, 2013  : Add "extra cameras" for 12 wooden posts

   video_camera_ID.push_back(11);
   video_camera_ID.push_back(12);
   
   vector<double> Rm;
   vector<int> Adeg,Amin,Asec;  // Angles are measured clockwise 
				// wrt +y_hat (north) axis:

// According to Will Lawrence, Nov 2012 Day 2 experiments were
// conducted at VENUS with radius = 40 meter for video camera tripods
...
*/
   ...
   if (expt_daynumber=="2")  // 40 meter VENUS
   {
      Rm.push_back(40.009);
      Rm.push_back(40.038);
      Rm.push_back(40.253);
   ...
   if (expt_daynumber=="10")  // Wooden posts
   {
      Rm.push_back(29.895);
      Rm.push_back(31.478);
      Rm.push_back(29.956);
...
//   string output_filename=bundler_IO_subdir+"measured_camera_posns.dat";
   string output_filename=bundler_IO_subdir+"wooden_post_posns.dat";
   ofstream outstream;
   filefunc::openfile(output_filename,outstream);

   vector<threevector> measured_camera_posn;
   for (int i=0; i<video_camera_ID.size(); i++)
   {
      double r=Rm.at(i);
...
//      outstream << "Video_Camera " << i+1 << "   "
      outstream << "Wooden_Post " << i+1 << "   "
