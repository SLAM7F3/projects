...
namespace KDTree
{
  ...
  template <size_t const __K, typename _Val, typename _SubVal,
    ...
    struct __Region
    {
      ...
      bool intersects_with(__Region const& __THAT) const throw ()
      {
      ...
      bool encloses(value_type const& __V) const throw ()
      {
        for (size_t __i = 0; __i < __K; ++__i)
          {
      ...
      __Region& set_high_bound(value_type const& __V, size_t const __L) 
             throw ()
      {
      ...
      __Region& set_low_bound(value_type const& __V, size_t const __L) throw ()
      {
