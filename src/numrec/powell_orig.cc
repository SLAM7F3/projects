...
the function value such that failure to decrease by more than this amount 
on one iteration signals completion.  On output, p is set to the best point 
...
The routine LINMIN is used by POWELL.  					*/
/* ==================================================================== */
/* Last modified on 4/17/01                                             */
/* ==================================================================== */
