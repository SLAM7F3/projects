...
/* =================================================================	*/
/* Given values for the variables y[1..n] and their derivatives
   dydx[1..n] known at x, use the fourth-order Runge-Kutta method to
   ...
   The user supplies the routine derivs(x,y,dydx) which returns
   derivatives dydx at x. 						*/
/* ==================================================================== */
/* Last modified on 4/8/01                                              */
/* ==================================================================== */
