...
// utility file nrutil.c.  Do not confuse this file with the
// same-named file nrutil.c that is supplied in the 'misc'
// subdirectory.  *That* file is the one from the book, and contains
// both ANSI and traditional K&R versions, along with #ifdef macros to
// select the correct version.  *This* file contains only ANSI C.
