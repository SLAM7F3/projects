...
void compute_nullspace_basis(int n, v2_t *a, v2_t *b, double *basis) {
    ...
    Q = static_cast<double*>(malloc(sizeof(double) * max_dim * max_dim));
    S = static_cast<double*>(malloc(sizeof(double) * max_dim));
    U = static_cast<double*>(malloc(sizeof(double) * max_dim * max_dim));
                        ...
                        double *R_out, double *t_out)
{
    ...
    r_pts_norm = static_cast<v2_t*>(malloc(sizeof(v2_t) * n));
    l_pts_norm = static_cast<v2_t*>(malloc(sizeof(v2_t) * n));
