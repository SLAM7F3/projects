// ==========================================================================
// Genfloatmatrix class member function definitions
// ==========================================================================
...
void genfloatmatrix::allocate_member_objects()
{
}		       

void genfloatmatrix::initialize_member_objects()
{
}

genfloatmatrix::genfloatmatrix(int m):
   genarray(m)
{
   ...
   if (m <= 0)
   {
      cout << "Error in genfloatmatrix constructor #1, m = " << m << endl;
      cout << "this = " << this << endl;
   }
}

genfloatmatrix::genfloatmatrix(int m,int n):
   genarray(m,n)
{
   allocate_member_objects();
   initialize_member_objects();
   ...
   if (m <=0 || n <=0)
   {
      cout << "Error in genfloatmatrix constructor #2" << endl;
      cout << "m = " << m << " n = " << n << endl;
   }
}

// ---------------------------------------------------------------------
genfloatmatrix::genfloatmatrix(const rotation& R):
   genarray(3,3)
{
   allocate_member_objects();
   initialize_member_objects();
...
// ---------------------------------------------------------------------
genfloatmatrix::genfloatmatrix(const tensor& T):
   genarray(T.get_dim(0),T.get_dim(1))
{
//    cout << "inside genfloatmatrix(Tensor) constructor" << endl
   allocate_member_objects();
   initialize_member_objects();

   if (T.get_rank() > 2)
   {
      cout << "Error in genfloatmatrix(tensor) constructor!" << endl;
...
// ---------------------------------------------------------------------
genfloatmatrix::genfloatmatrix(const genvector& V):
  genarray(V.get_mdim())
{
   allocate_member_objects();
   initialize_member_objects();
...
genfloatmatrix::genfloatmatrix(const genfloatmatrix& m):
   genarray(m)
{
//   cout << "inside genfloatmatrix copy constructor" << endl;
   docopy(m);
}

genfloatmatrix::~genfloatmatrix()
{
}

// ---------------------------------------------------------------------
void genfloatmatrix::docopy(const genfloatmatrix& m)
{
//   cout << "inside genfloatmatrix::docopy()" << endl;
   genarray::docopy(m);
}	

// Overload = operator:

genfloatmatrix& genfloatmatrix::operator= (const genfloatmatrix& m)
{
//   cout << "inside genfloatmatrix::operator==" << endl;
...
ostream& operator<< (ostream& outstream,const genfloatmatrix& A)
{
   outstream << endl;
...
// genvector containing the contents of the current genfloatmatrix object's
// mth row [nth column].

genvector genfloatmatrix::get_row(int m) const
{
   genvector row(ndim);
   const float *a = get_e_ptr() + m * ndim;
   const float *aMax = a + ndim;
...
void genfloatmatrix::get_row(int m, genvector& row) const
{
   const float *a = get_e_ptr() + m * ndim;
   const float *aMax = a + ndim;
...
void genfloatmatrix::put_row(int m, const genvector& row) 
{
...
// from input genfloatmatrix M into the mth row of *this:

void genfloatmatrix::copy_row(int m, const genfloatmatrix& M) 
{
   for (unsigned int n = 0 ; n < ndim; n++)
   {
      put(m, n, M.get(m,n));
...
void genfloatmatrix::renormalize_row(int m)
{
   put_row(m, get_row(m).unitvector());
}

genvector genfloatmatrix::get_column(int n) const
{
   genvector column(mdim);

   const float* a = get_e_ptr() + n;
   const float *aMax = a + ndim*mdim;
...
void genfloatmatrix::get_column(int n,genvector& column) const
{
   const float* a = get_e_ptr() + n;
   const float *aMax = a + ndim*mdim;
...
void genfloatmatrix::put_column(int n,const genvector& column) 
{
...
void genfloatmatrix::renormalize_column(int n)
{
...
void genfloatmatrix::put_smaller_column(int n,const genvector& column) 
{
   put_smaller_column(0,n,column);
}

void genfloatmatrix::put_smaller_column(int m_start,int n,const genvector& column) 
{
...
void genfloatmatrix::put_smaller_matrix(const genfloatmatrix& M)
{
   put_smaller_matrix(0,0,M);
}

void genfloatmatrix::put_smaller_matrix(
   int m_start,int n_start,const genfloatmatrix& M)
{
...
// Member function get_smaller_matrix() takes in genfloatmatrix M whose
// mdim <= this->mdim and ndim <= this->ndim.  It copies the reduced
// rows and columns of *this into M.

void genfloatmatrix::get_smaller_matrix(genfloatmatrix& M)
{
   for (unsigned int m=0; m<M.get_mdim(); m++)
   {
      for (unsigned int n=0; n<M.get_ndim(); n++)
...
float genfloatmatrix::rows_dotproduct(int r1, int r2)
{
   float* a = get_e_ptr() + r1 * ndim;
   float* b = get_e_ptr() + r2 * ndim;
   float *aMax = a + ndim;
...
float genfloatmatrix::columns_dotproduct(int c1, int c2)
{
   float* a = get_e_ptr() + c1;
   float* b = get_e_ptr() + c2;
   float *aMax = a + ndim*mdim;
...
void genfloatmatrix::clear_matrix_values()
{
...
genfloatmatrix genfloatmatrix::transpose() const
{
   genfloatmatrix Atrans(ndim,mdim);
...
// ---------------------------------------------------------------------
genfloatmatrix genfloatmatrix::absolute_value() const
{
   genfloatmatrix A_abs(ndim,mdim);
...
void genfloatmatrix::identity()
{
   ...
   {
      cout << "Error inside genfloatmatrix::identity()!" << endl;
...
genfloatmatrix genfloatmatrix::commutator(const genfloatmatrix& A) const
{
   if (mdim==A.mdim && ndim==A.ndim)
   {
      genfloatmatrix C(mdim,ndim);
      C=*this*A-A*(*this);
      return C;
   }
   else
   {
      cout << "Error inside genfloatmatrix::commutator() !" << endl;
      cout << "mdim = " << mdim << " ndim = " << ndim << endl;
...
genfloatmatrix genfloatmatrix::anticommutator(const genfloatmatrix& A) const
{
   if (mdim==A.mdim && ndim==A.ndim)
   {
      genfloatmatrix C(mdim,ndim);
   ...
   {
      cout << "Error inside genfloatmatrix::anticommutator() !" << endl;
      cout << "mdim = " << mdim << " ndim = " << ndim << endl;
...
// ---------------------------------------------------------------------
float genfloatmatrix::trace() const
{
   if (mdim==ndim)
   {
      float tr=0;
   ...
   {
      cout << "Error in genfloatmatrix::trace()!" << endl;
      cout << "mdim = " << mdim << " ndim = " << ndim << endl;
...
// ---------------------------------------------------------------------
genfloatmatrix genfloatmatrix::power(unsigned int n)
{
   if (mdim==ndim)
   {
      genfloatmatrix B(mdim,ndim);
   ...
   {
      cout << "Error in genfloatmatrix::power()!" << endl;
      cout << "mdim = " << mdim << " ndim = " << ndim << endl;
...
genfloatmatrix genfloatmatrix::elementwise_product(const genfloatmatrix& M)
{
   genfloatmatrix product(mdim,ndim);
   if (mdim != M.get_mdim() || ndim != M.get_ndim())
   {
      cout << "Error in genfloatmatrix::elementwise_product()!" << endl;
      cout << "mdim = " << mdim << " ndim = " << ndim << endl;
...
void genfloatmatrix::elementwise_power(const genfloatmatrix& M, float alpha)
{
   if (mdim != M.get_mdim() || ndim != M.get_ndim())
   {
      cout << "Error in genfloatmatrix::elementwise_sqr()!" << endl;
      cout << "mdim = " << mdim << " ndim = " << ndim << endl;
      cout << "M.mdim = " << M.get_mdim() << " M.ndim = " << M.get_ndim()
           << endl;
   }
...
// ---------------------------------------------------------------------
void genfloatmatrix::hadamard_sqrt(const genfloatmatrix& M)
{
   for (unsigned int m=0; m<mdim; m++)
   {
      for (unsigned int n=0; n<ndim; n++)
...
// ---------------------------------------------------------------------
genfloatmatrix genfloatmatrix::hadamard_power(float alpha)
{
   genfloatmatrix B(mdim, ndim);
...
void genfloatmatrix::hadamard_sum(float alpha) 
{
   for (unsigned int m=0; m<mdim; m++)
   {
      for (unsigned int n=0; n<ndim; n++)
...
void genfloatmatrix::hadamard_division(const genfloatmatrix& D)
{
   for (unsigned int m=0; m<mdim; m++)
   {
      for (unsigned int n=0; n<ndim; n++)
      {
         put(m, n, get(m,n) / D.get(m,n));
      } // loop over index n
   } // loop over index m
}
...
// squared matrix element within the current genfloatmatrix object.

float genfloatmatrix::sqrd_Frobenius_norm()
{
...
float genfloatmatrix::max_element_value()
{
   float max_value=NEGATIVEINFINITY;
   for (unsigned int m=0; m<mdim; m++)
   {
      for (unsigned int n=0; n<ndim; n++)
      {
         float curr_value=get(m,n);
...
float genfloatmatrix::max_abs_element_value()
{
   int m_max,n_max;
   return max_abs_element_value(m_max,n_max);
}

float genfloatmatrix::max_abs_element_value(int& m_max,int& n_max)
{
   float max_abs_value=NEGATIVEINFINITY;
   for (unsigned int m=0; m<mdim; m++)
   {
      for (unsigned int n=0; n<ndim; n++)
      {
         float curr_abs_value=fabs(get(m,n));
...
float genfloatmatrix::max_abs_element_difference()
{
   float max_abs_diff=NEGATIVEINFINITY;
   for (unsigned int i=0; i<mdim*ndim; i++)
   {
      ...
      {
         float value_j=get(j);
         float abs_diff=fabs(value_j-value_i);
...
// entries within the current genfloatmatrix.  After computing the median
...
// genfloatmatrix.  For determinant and matrix inverse computations, it is
// useful to first factor out the geometric mean scale if it
// significantly differs from 1.

float genfloatmatrix::compute_geometric_mean_scale() const
{
   vector<float> log_values;

   for (unsigned int i=0; i<mdim; i++)
   {
      for (unsigned int j=0; j<mdim; j++)
      {
         float curr_value=fabs(get(i,j));
         if (curr_value > 0)
         {
   ...
   float median_log=mathfunc::median_value(log_values);
   float geometric_mean_scale=exp(median_log);
...
float genfloatmatrix::determinant() const
{
//   cout << "inside genfloatmatrix::determinant() #1" << endl;
   ...
   else
   {
      ...
      if (!det_OK_flag)
      {
         cout << "Error in genfloatmatrix::determinant() !!!" << endl;
...
float genfloatmatrix::two_determinant() const
{
   float a=get(0,0);
   float b=get(0,1);
   float c=get(1,0);
...
float genfloatmatrix::three_determinant() const
{
   float a=get(0,0);
   float b=get(0,1);
   float c=get(0,2);
...
// ---------------------------------------------------------------------
bool genfloatmatrix::determinant(float& d) const
{
//   cout << "inside genfloatmatrix::determinant() #2" << endl;
//   cout << "mdim = " << mdim << " ndim = " << ndim << endl;
...
// ---------------------------------------------------------------------
bool genfloatmatrix::determinant(float& d,float& scaleless_det) const
{
//   cout << "inside genfloatmatrix::determinant() #3" << endl;
//   cout << "mdim = " << mdim << " ndim = " << ndim << endl;

   if (mdim != ndim) return false;

   float geometric_mean_scale=compute_geometric_mean_scale();
...
bool genfloatmatrix::inverse(genfloatmatrix& Ainv) const
{
//   cout << "inside genfloatmatrix::inverse()" << endl;
   if (mdim != ndim) return false;

   float det,scaleless_det;
   determinant(det,scaleless_det);
   if ( fabs(scaleless_det) < 1E-50 ) return false;
//   if ( fabs(determinant()) < 1E-50 ) return false;

   genfloatmatrix U(mdim,mdim),W(mdim,mdim),Winv(mdim,mdim),V(mdim,mdim);
...
bool genfloatmatrix::two_inverse(genfloatmatrix& Ainv) const
{
//   cout << "inside genfloatmatrix::inverse()" << endl;
...
bool genfloatmatrix::sorted_singular_value_decomposition(
   genfloatmatrix& Usorted,genfloatmatrix& Wsorted,genfloatmatrix& Vsorted) const
{
//   cout << "inside genfloatmatrix::sorted_singular_value_decomposition()" << endl;
//   cout << "mdim = " << mdim << " ndim = " << ndim << endl;
   if (mdim < ndim)
   {
      genfloatmatrix transposed(ndim,mdim);
      genfloatmatrix X(ndim,mdim);
      genfloatmatrix Y(mdim,mdim);
      genfloatmatrix Z(mdim,mdim);
...
bool genfloatmatrix::sorted_singular_value_decomposition_w_mdim_less_than_ndim(
   genfloatmatrix& Usorted,genfloatmatrix& Wsorted,genfloatmatrix& Vsorted) const
{
   Matrix A(mdim,ndim);
   for (unsigned int i=0; i<mdim; i++)
...
// U*W*Vtrans on the current genfloatmatrix object.  It then sets to zero
...
bool genfloatmatrix::pseudo_inverse(
   float min_abs_singular_value,genfloatmatrix& Apseudo_inverse) const
{
//   cout << "inside genfloatmatrix::pseudo_inverse()" << endl;
   genfloatmatrix U(mdim,ndim),W(ndim,ndim),V(ndim,ndim);
...
//   cout << "VT*V = " << V.transpose()*V << endl;
   ...
   genfloatmatrix Wpseudo_inverse(ndim,ndim);
   Wpseudo_inverse.clear_values();

   for (unsigned int n=0; n<ndim; n++)
   {
      float currw=W.get(n,n);
...
// genfloatmatrix A.  It returns (Atrans A)**-1 Atrans which yields the least-
// squares solution to A x = b.

genfloatmatrix genfloatmatrix::pseudo_inverse()
{
//   cout << "inside genfloatmatrix::pseudo_inverse()" << endl;

   genfloatmatrix trans=transpose();	// ndim x mdim
   genfloatmatrix product=trans * (*this); // ndim x ndim
   genfloatmatrix inv(ndim,ndim);
   product.inverse(inv);	// ndim x ndim
   genfloatmatrix pseudo=inv*trans;	// ndim x mdim
...
bool genfloatmatrix::cholesky_decomposition(genfloatmatrix& L) const
{
   if (mdim != ndim)
   {
      cout << "Error in genfloatmatrix::cholesky_decomposition()" << endl;
...
//   cout << "Before LTM call in genfloatmatrix::cholesky_decomposition()" << endl;
   LowerTriangularMatrix LTM=Cholesky(S);
//   cout << "After LTM call in genfloatmatrix::cholesky_decomposition()" << endl;
...
bool genfloatmatrix::sym_eigen_decomposition(genfloatmatrix& D,genfloatmatrix& U) const
{
   if (mdim != ndim)
   {
      cout << "Error in genfloatmatrix::sym_eigen_decomposition()" << endl;
      cout << "mdim = " << mdim << " does not equal ndim = " << ndim
           << endl;
      return false;
   }
...
bool genfloatmatrix::square_root(genfloatmatrix& Sqrt)
{
//   cout << "inside genfloatmatrix::square_root()" << endl;
   if (mdim != ndim) return false;

   genfloatmatrix D(mdim,mdim),U(mdim,mdim),Dsqrt(mdim,mdim);
...
//   cout << "D = " << D << " U = " << U << endl;
   ...
   {
      float curr_diag_value=D.get(d,d);
...
// ---------------------------------------------------------------------
// Member function decompose_sym works with the current genfloatmatrix
...
//   cout << "theta = " << theta*180/PI << " phi = " << phi*180/PI << endl;
   ...
   genfloatmatrix U_reconstructed(3,3);
...
void genfloatmatrix::reconstruct_sym(
   const threevector& lambda,float theta,float phi,float chi,float detU) 
{
   genfloatmatrix D(3,3),U(3,3);
...
void genfloatmatrix::reconstruct_inverse_sym(
   const threevector& lambda,float theta,float phi,float chi,float detU) 
{
   genfloatmatrix D(3,3),U(3,3);
...
rotation genfloatmatrix::projection_rotation()
{
//   cout << "inside genfloatmatrix::projection_rotation()" << endl;
   
   genfloatmatrix U(3,3),W(3,3),V(3,3);
   rotation R;
...
void genfloatmatrix::flipud(genfloatmatrix& A_flipud) const
{
...
void genfloatmatrix::reverselr(genfloatmatrix& A_reverselr) const
{
   for (unsigned int r=0; r<mdim; r++)
   {
      for (unsigned int c=0; c<ndim; c++)
...
// the Eigen library in order to decompose the current genfloatmatrix into
// a product Q*R where Q is an orthogonal matrix and R is an upper
// triangular matrix.

void genfloatmatrix::QR_decomposition(genfloatmatrix& Q,genfloatmatrix& R) const
{
...
void genfloatmatrix::RQ_decomposition(genfloatmatrix& R,genfloatmatrix& Q) const
{
//   cout << "inside genfloatmatrix::RQ_decomposition()" << endl;
   
   genfloatmatrix A_flipud(mdim,ndim);
   flipud(A_flipud);
//   cout << "A_flipud = " << A_flipud << endl;
   
   genfloatmatrix Atransflip(ndim,mdim);
   Atransflip=A_flipud.transpose();
//   cout << "Atransflip = " << Atransflip << endl;

   genfloatmatrix Qtransflip(ndim,mdim),Rtransflip(ndim,mdim);
...
//        << Qtransflip * Rtransflip << endl;
   ...
   genfloatmatrix Rflipped(mdim,ndim),Qflipped(mdim,ndim);
   Rflipped=Rtransflip.transpose();
//   cout << "Rflipped = " << Rflipped << endl;

   genfloatmatrix Rreversed(mdim,ndim);
...
// decomposition U * W * Vtrans on the current genfloatmatrix object M.  If
...
bool genfloatmatrix::homogeneous_soln(genvector& X) const
{
//   cout << "inside genfloatmatrix::homogenous_soln()" << endl;
   genfloatmatrix U(mdim,ndim),W(ndim,ndim),V(ndim,ndim);
   if (!sorted_singular_value_decomposition(U,W,V)) return false;
...
// genfloatmatrix M=*this, genvector B is passed as input and genvector X
// is returned.  It performs a singular value decomposition U * W *
// Vtrans on M.  Provided W contains no zero singular values, X = V *
// W^-1 * Utrans * B.

bool genfloatmatrix::inhomogeneous_soln(const genvector& B,genvector& X) const
{
...
// genfloatmatrix A=*this, while genvector B is passed as input.  Genvector
// X is returned by this method.  Use this method to solve for X
// rather than inverting A in order to speed up processing time!

bool genfloatmatrix::solve_linear_system(const genvector& B,genvector& X) const
{
   if (mdim==ndim)
   {
...
// float *vec and then call the Numerical Recipes function
// vec=vector(1,mdim).  Similarly, matrices are initially declared as
// float **mat and then converted to Numerical Recipes routine form
// via the call mat=matrix(1,mdim,1,mdim).  
    
      int *indx=numrec::ivector(1,mdim);
      float *b=numrec::vector(1,mdim);
      float **A1=numrec::matrix(1,mdim,1,mdim);
...
//  Load the values of b into output genvector X:
   ...
   {
      cout << "Error in genfloatmatrix::solve_linear_system()!" << endl;
      cout << "mdim = " << mdim << " ndim = " << ndim << endl;
...
// of the current genfloatmatrix object:

unsigned int genfloatmatrix::rank() const
{
//   cout << "inside genfloatmatrix::rank()" << endl;
//   cout << "*this = " << *this << endl;
...
// genfloatmatrix object.  It performs a singular value decomposition and
...
// rank r approximation to the current genfloatmatrix object.

bool genfloatmatrix::rank_approximation(
   unsigned int r,genfloatmatrix& Ur,genfloatmatrix& Wr,genfloatmatrix& Vr)
{
//   cout << "inside genfloatmatrix::rank_approximation()" << endl;
...
bool genfloatmatrix::rank_approximation(
   unsigned int r,genfloatmatrix& reduced_rank_matrix)
{
//   cout << "inside genfloatmatrix::rank_approximation()" << endl;
   if (r > rank()) r=rank();
...
// the current genfloatmatrix object and searches for values equal to the
...
void genfloatmatrix::generate_mask_matrix(float null_value,genfloatmatrix& M)
{
   for (unsigned int m=0; m<mdim; m++)
   {
      for (unsigned int n=0; n<ndim; n++)
...
int genfloatmatrix::number_nonzero_entries(float TINY)
{
...
// the current genfloatmatrix to an output file following the formats used
// by the SVDLIBC library.  See http://tedlab.mit.edu/~dr/SVDLIBC/

void genfloatmatrix::export_to_dense_text_format(string output_filename)
{
   string banner="Exporting genfloatmatrix to dense text format";
...
// command-line SVDLIBC calls in order to save the current genfloatmatrix
// contents into output binary files.

void genfloatmatrix::export_to_dense_binary_format(string output_filename)
{
   string banner="Exporting genfloatmatrix to dense binary format";
   outputfunc::write_banner(banner);
...
// ---------------------------------------------------------------------
void genfloatmatrix::export_to_sparse_text_format(string output_filename)
{
   string banner="Exporting genfloatmatrix to sparse text format";
   outputfunc::write_banner(banner);
   ...
   } // loop over index n labeling genfloatmatrix columns

   filefunc::closefile(output_filename,outstream);
}

// ---------------------------------------------------------------------
void genfloatmatrix::export_to_sparse_binary_format(string output_filename)
{
   string banner="Exporting genfloatmatrix to sparse binary format";
   outputfunc::write_banner(banner);
...
// ---------------------------------------------------------------------
void genfloatmatrix::sparse_SVD_approximation(int k_dims)
{
...
// are more efficient than these deprecated genfloatmatrix versions.

/*
// Overload *= and /= operators:


void genfloatmatrix::operator*= (float a)
{
  for (unsigned int i=0; i<mdim; i++)
  {
     for (unsigned int j=0; j<ndim; j++)
...
void genfloatmatrix::operator/= (float a)
{
   ...
   {
      cout << "Division by zero error inside genfloatmatrix::operator/= !"
           << endl;
   }
}
*/
...
genfloatmatrix operator+ (const genfloatmatrix& A,const genfloatmatrix& B)
{
   if (A.mdim==B.mdim && A.ndim==B.ndim)
   {
      genfloatmatrix C(A.mdim,A.ndim);
   ...
   {
      cout << "Error inside operator+ in genfloatmatrix.cc class!" << endl;
...
genfloatmatrix operator- (const genfloatmatrix& A)
{
   genfloatmatrix B(A.mdim,A.ndim);
...
// ==========================================================================
// Overload * operator for multiplying a genfloatmatrix by a scalar
// ==========================================================================

genfloatmatrix operator* (float a,const genfloatmatrix& A)
{
   genfloatmatrix B(A.mdim,A.ndim);
...
genfloatmatrix operator* (const genfloatmatrix& A,float a)
{
   return a*A;
}
...
genfloatmatrix operator/ (const genfloatmatrix& A,float a)
{
   ...
   {
      cout << "Division by zero error inside operator/ friend function of genfloatmatrix class!"
           << endl;
      exit(-1);
   }
}
...
genfloatmatrix operator* (const genfloatmatrix& A,const genfloatmatrix& B)
{
   if (A.ndim==B.mdim)
   {
      genfloatmatrix C(A.mdim,B.ndim);
   ...
   {
      cout << "Error in operator* friend function of genfloatmatrix class!"
           << endl;
...
genfloatmatrix operator* (const genfloatmatrix& A, const genfloatmatrix& B)
{
   ...
   genfloatmatrix C(A_mdim,B_ndim);
   C.clear_values();
   ...
   for (unsigned int i = 0; i < A_mdim; i++)
   {
      ...
      {
         const float* a = A.get_e_ptr() + i * A_ndim + k;
         const float* b = B.get_e_ptr() + k * B_ndim;
         float *c = C.get_e_ptr() + i * B_ndim;
         float *cMax = c + B_ndim;
...
void genfloatmatrix::matrix_sum(const genfloatmatrix& A,const genfloatmatrix& B)
{
   for (unsigned int i = 0; i < A.mdim; i++)
   {
      for (unsigned int j = 0; j < A.ndim; j++)
...
void genfloatmatrix::matrix_increment(float alpha, const genfloatmatrix& B)
{
...
void genfloatmatrix::matrix_transpose(const genfloatmatrix& A)
{
   for (unsigned int i = 0; i < A.mdim; i++)
   {
      for (unsigned int j = 0; j < A.ndim; j++)
...
void genfloatmatrix::matrix_mult(const genfloatmatrix& A, const genfloatmatrix& B)
{
   clear_values();

//   cout << "inside genfloatmatrix::matrix_mult()" << endl;
...
//        << endl;
   ...
   const float* A_e_ptr = A.get_e_ptr();
   const float* B_e_ptr = B.get_e_ptr();
   float* C_e_ptr = get_e_ptr();
   
   for (int i = 0; i < A_mdim; i++)
   {
      for (int k = 0; k < A_ndim; k++)
      {
         const float* a = A_e_ptr + i * A_ndim + k;
         const float* b = B_e_ptr + k * B_ndim;
         float *c = C_e_ptr + i * B_ndim;
         float *cMax = c + B_ndim;
...
void genfloatmatrix::matrix_column_mult(const genfloatmatrix& A, const genfloatmatrix& B,
                                   int bcol)
{
   float sum = 0;
...
void genfloatmatrix::matrix_column_mult_sum(
   const genfloatmatrix& A, const genfloatmatrix& B, const genvector& V, int bcol)
{
   float sum = 0;
   int A_mdim = A.get_mdim();
   int A_ndim = A.get_ndim();
   for (int i = 0; i < A_mdim; i++)
   {
      ...
      put(i, bcol, sum + V.get(i));
   }
}

void genfloatmatrix::accumulate_outerprod(const genvector& A,const genvector& B)
{
   for (unsigned int i = 0; i < A.mdim; i++)
   {
      float curr_A = A.get(i);
